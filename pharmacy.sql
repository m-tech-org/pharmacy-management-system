...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2021 at 06:39 PM
...
('987106', 'Vijay', 'Chow', 60, 'Male', '8996574123', 'vijayc@yahoo.com'),
('987107', 'park', 'kim', 35, 'Female', '7845963259', 'park@gmail.com');


-- DELIMITER $$
-- SET FOREIGN_KEY_CHECKS = 0;
-- CREATE TRIGGER `C_ID_DELETE` BEFORE DELETE ON `customer` FOR EACH ROW BEGIN
-- DELETE from customer WHERE customer.C_ID=old.C_ID;
...
('4567001', 'Varsha', 'Elangovan', '1995-10-05', 25, 'Female', 'Pharmacist', '2017-11-12', '25000.00', '9967845123', 'evarsh@hotmail.com', 'Thiruvanmiyur'),
...
('4567010', 'Daniel', 'Radcliffe', '1993-04-05', 27, 'Male', 'Pharmacist', '2016-01-05', '30000.00', '7896541235', 'daniels@gmail.com', 'Kodambakkam');


-- DELIMITER $$
-- SET FOREIGN_KEY_CHECKS = 0;
-- CREATE TRIGGER `E_ID_DELETE` BEFORE DELETE ON `employee` FOR EACH ROW BEGIN
-- DELETE from employee WHERE employee.E_ID=old.E_ID;
-- SET FOREIGN_KEY_CHECKS = 1;
-- END
-- $$
-- DELIMITER ;
...
('156', 'MedAll', 'Chattagram', '9874585236', 'hipharma@medall.com'),
